...
new TypeIt("#teks1", {
  strings: ["Hari ini, aku langitkan semua doa terbaik aku untuk km.", "Semoga hal-hal yang membuat km runtuh turut menjadi alasan km untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga km dimanapun km berada.", "Semoga hari-hari km selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang km inginkan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan km bagimanapun cara na.", " ", "selamat ulang tahun lalap💙, terima kasih udah lahir di dunia ini.",  "aku paham kdng suasana d rumah atau d tempat kerja bikin capek","tapi aku yakin km bisa lewatin semua itu","- last but not least Wish you all the best even without me"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
